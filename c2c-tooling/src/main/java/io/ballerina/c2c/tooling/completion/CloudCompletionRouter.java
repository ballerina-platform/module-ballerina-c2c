...
import io.ballerina.c2c.tooling.completion.toml.Parent;
import io.ballerina.c2c.tooling.completion.toml.ParentType;
import io.ballerina.c2c.tooling.completion.toml.Table;
import io.ballerina.c2c.tooling.completion.toml.TableArray;
import io.ballerina.c2c.tooling.completion.toml.TomlSnippetManager;
...
public class CloudCompletionRouter {
    ...
    private static CompletionItem createRootCompletionItem(String key, String type, String insertText) {
        ...
        item.setSortText(CommonUtil.genSortText(3));
        return item;
    }
