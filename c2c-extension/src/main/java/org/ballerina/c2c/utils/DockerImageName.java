...
package org.ballerina.c2c.utils;
...
public class DockerImageName {
     ...
     */
    public DockerImageName(String fullName) {
        this(fullName, null);
    }
     ...
     */
    public DockerImageName(String fullName, String givenTag) {
        if (fullName == null) {
    ...
    private void doValidate() {
        ...
        if (errors.size() > 0) {
            ...
            buf.append("Given Docker name '").append(getFullName()).append("' is invalid:\n");
