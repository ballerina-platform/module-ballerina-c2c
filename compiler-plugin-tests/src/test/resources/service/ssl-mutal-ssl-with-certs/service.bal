...
http:ListenerConfiguration mutualSslCertServiceConf = {
    secureSocket: {
        key: {
            certFile: "src/test/resources/service/security/public.crt",
            keyFile: "src/test/resources/service/security/private.key"
        },
        mutualSsl: {
            verifyClient: http:REQUIRE,
            cert: "src/test/resources/service/security/public.crt"
        }
    }
};
